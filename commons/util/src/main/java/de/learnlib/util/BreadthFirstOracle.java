...
public abstract class BreadthFirstOracle<A extends SimpleDTS<?, I>, I, D, Q extends Query<I, D>>
    ...
    /**
     * Constructs a new BreadthFirstOracle.
     *
     * @param maxWords the maximum number of words to generate.
     */
    protected BreadthFirstOracle(int maxWords) {
    ...
    /**
     * An implementation of a {@link BreadthFirstOracle}, that uses {@link DefaultQuery}s, and a
     ...
     * @param <D> the output type
     */
    public abstract static class DefaultBreadthFirstOracle<A extends SimpleDTS<?, I>, I, D>
            extends BreadthFirstOracle<A, I, D, DefaultQuery<I, D>>
        ...
        /**
         * Constructs a new DefaultBreadthFirstOracle.
         *
         * @param maxWords the maximum number of words to generate.
         * @param membershipOracle the membership oracle to answer {@link DefaultQuery}s.
         */
        protected DefaultBreadthFirstOracle(int maxWords, MembershipOracle<I, D> membershipOracle) {
            super(maxWords);
