...
import de.learnlib.util.BreadthFirstOracle;
 ...
 */
public abstract class LassoAutomatonEmptinessOracle<L extends Lasso<?, ?, I, D>, S, I, D>
        extends BreadthFirstOracle<L, I, D, OmegaQuery<S, I, D>>
    ...
    /**
     * Constructs a new {@link LassoAutomatonEmptinessOracle}.
     *
     * @param omegaMembershipOracle the {@link OmegaMembershipOracle} used to answer {@link OmegaQuery}s.
     */
    protected LassoAutomatonEmptinessOracle(OmegaMembershipOracle<S, I, D> omegaMembershipOracle) {
        super(1);
    ...
    public boolean isCounterExample(L lasso, OmegaQuery<S, I, D> query) {
        ...
        // check condition 1
        if (!LassoEmptinessOracle.super.isCounterExample(lasso, query)) result = false;
        else {
    ...
    public static class DFALassoDFAEmptinessOracle<S, I>
            extends LassoAutomatonEmptinessOracle<DFALasso<?, I>, S, I, Boolean>
            implements DFALassoEmptinessOracle<S, I> {

        public DFALassoDFAEmptinessOracle(DFAOmegaMembershipOracle<S, I> membershipOracle) {
            super(membershipOracle);
        }
    }

    public static class MealyLassoMealyEmptinessOracle<S, I, O>
            extends LassoAutomatonEmptinessOracle<MealyLasso<?, I, O>, S, I, Word<O>>
            implements MealyLassoEmptinessOracle<S, I, O> {

        public MealyLassoMealyEmptinessOracle(MealyOmegaMembershipOracle<S, I, O> membershipOracle) {
            super(membershipOracle);
        }
    }
}
