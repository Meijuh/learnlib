 ...
 */
public abstract class BaseBlackBoxOracle<A, I, D, P extends BlackBoxProperty<?, A, I, D>>
    ...
    /**
     * Constructs a new {@link BaseBlackBoxOracle} with a set of properties.
     *
     * @param properties the set of {@link BlackBoxProperty}s that need to be verified.
     */
    protected BaseBlackBoxOracle(Set<P> properties) {
        this.properties = new HashSet();
        this.properties.addAll(properties);
        for (P p : this.properties) p.useCache();
    }

    /**
     * Constructs a new {@link BaseBlackBoxOracle} with a single property.
     *
     * @param property the {@link BlackBoxProperty}.
     */
    protected BaseBlackBoxOracle(P property) {
        this(Collections.singleton(property));
    }

    /**
     * Constructs a new {@link BaseBlackBoxOracle} with no properties.
     */
    protected BaseBlackBoxOracle() {
