...
import static de.learnlib.api.oracle.BlackBoxOracle.BlackBoxProperty;
 ...
 */
public class DisproveFirstBBOracle<A, I, D, P extends BlackBoxProperty<?, A, I, D>>
        extends BaseBlackBoxOracle<A, I, D, P> {
    ...
    public DefaultQuery<I, D> findCounterExample(A hypothesis, Collection<? extends I> inputs) throws ModelCheckingException {
        for (P p : getProperties()) if (!p.isDisproved()) p.disprove(hypothesis, inputs);
