...
import net.automatalib.parser.FSM2MealyParserIO;
 ...
 */
public class LTSminLTLIO<I, O> extends LTSminLTLMealy<I, O> {
    ...
    @Override
    protected CompactMealy fsm2Mealy(File fsm) throws IOException, FSMParseException {
        final CompactMealy mealy =  FSM2MealyParserIO.parse(fsm, getString2Input(), getString2Output());
        return mealy;
    }
